...
import CandidateInterviewForm from '../forms/CandidateInterviewForm';


class CandidateInterviewContainer extends React.Component {

    constructor() {
        super();

        this.state = {
            interviewInvitationWasSent: false
        }
    ...
    onSubmit(values) {
        ...
        request
            .post('/entrevistar_candidato')
            .send(data)
            .set('application/json')
            .end((err, res) => {
                if (res.statusCode == 200) {
                    this.setState({interviewInvitationWasSent: true});
    ...
    render() {        
        return (            
            ...
            {
                this.state.interviewInvitationWasSent ?
                <div className='text-center'>
                    <i className="fa fa-check-circle text-success mb-3 display-3"></i> 
                    <p className="pb-3">Se a enviado un correo a {this.props.candidateName} para realizar un entrevista.</p>
                </div>
                :
                <div>
                    <CandidateInterviewForm candidateName={this.props.candidateName} />
                    <div className="text-center">
...
CandidateInterviewContainer.proptypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(CandidateInterviewContainer);